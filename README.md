...
Download [pushbullet.hpi](https://bintray.com/jcgay/maven/download_file?file_path=fr%2Fjcgay%2Fjenkins%2Fplugins%2Fpushbullet%2F0.1.1%2Fpushbullet-0.1.1.hpi) and install it manually in Jenkins (`http://jenkins/pluginManager/advanced`).
